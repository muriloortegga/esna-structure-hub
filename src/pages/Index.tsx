    ...
    <Layout>
      ...
      <section className="relative -mt-16 md:-mt-20 min-h-[100svh] flex flex-col">
        ...
        <div className="container-x flex-1 flex flex-col justify-end pb-20 md:pb-28 pt-32">
          ...
          <h1 className="display text-[52px] sm:text-7xl md:text-[110px] max-w-6xl leading-[1.0] text-foreground">
          ...
          <div className="mt-12 flex flex-wrap gap-4">
            <Link to="/solucoes" className="btn-primary flex items-center gap-3">
              Nossas soluções <ArrowRight size={14} />
            </Link>
            <Link
              to="/projetos"
              className="inline-flex items-center gap-3 px-8 py-3 border border-accent/30 text-foreground font-mono text-xs uppercase tracking-widest hover:bg-accent/10 transition-all duration-300"
            >
              Ver portfólio
            </Link>
          </div>
      ...
      <section className="container-x py-32 md:py-48 relative overflow-hidden">
        <div className="absolute right-0 top-1/2 -translate-y-1/2 text-[20vw] font-display text-foreground/[0.02] select-none pointer-events-none leading-none tracking-tighter">
          ESNA
        </div>
        <div className="grid md:grid-cols-12 gap-16 relative z-10">
          <div className="md:col-span-7">
            <span className="earmark mb-8 block">Sobre a ESNA</span>
            <h2 className="display text-5xl md:text-7xl leading-[1.05] text-foreground">
            ...
            <div className="mt-12 flex flex-col justify-end space-y-8 text-xl text-slate leading-relaxed font-ui max-w-xl">
              ...
              <p className="text-foreground border-l border-accent pl-8 py-2 italic">
                Não executamos apenas tarefas avulsas. <span className="font-bold not-italic">Entregamos estrutura.</span>
              </p>
            </div>
          </div>
          <div className="md:col-span-4 md:col-start-9 flex flex-col justify-center space-y-16 py-12 px-8 bg-depth text-foreground relative">
            <div className="absolute inset-0 pattern-rects opacity-10 pointer-events-none" />
            <span className="earmark block relative z-10">Números</span>
            <div className="grid grid-cols-1 gap-12 relative z-10">
              <div className="flex flex-col">
                <span className="display text-5xl text-accent font-bold">+10</span>
                <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-foreground/50 mt-2">Anos de atuação</span>
              </div>
              <div className="rule-thin" />
              <div className="flex flex-col">
                <span className="display text-5xl text-accent font-bold">9</span>
                <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-foreground/50 mt-2">Áreas integradas</span>
              </div>
              <div className="rule-thin" />
              <div className="flex flex-col">
                <span className="display text-5xl text-accent font-bold">+50</span>
                <span className="font-mono text-[9px] uppercase tracking-[0.2em] text-foreground/50 mt-2">Projetos entregues</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ESSÊNCIA / PILARES */}
      <section className="bg-surf2 border-y border-accent/10 relative overflow-hidden">
        ...
        <div className="container-x py-32 md:py-48 relative z-10">
          ...
          <h2 className="display text-5xl md:text-7xl leading-[1.05] text-foreground mb-20">
          ...
          <div className="grid md:grid-cols-3 gap-16">
            {[
              ...
              <div key={p.tag} className="flex flex-col">
                ...
                <h3 className="display text-2xl text-foreground mb-6">{p.title}</h3>
      ...
      <section className="container-x py-32 md:py-48">
        <div className="flex items-end justify-between mb-24 flex-wrap gap-8">
          ...
          <Link to="/solucoes" className="font-mono text-[11px] uppercase tracking-widest font-bold border-b border-accent pb-1 text-foreground hover:text-accent transition-colors">
          ...
          {[
            ...
            <div key={s.t} className="service-card group">
              ...
              <div className="space-y-4">
                <h3 className="display text-3xl text-foreground group-hover:text-accent transition-colors duration-500">{s.t}</h3>
      ...
      <section className="container-x py-32 md:py-48">
        <div className="flex items-end justify-between mb-24 flex-wrap gap-8">
          ...
          <Link to="/projetos" className="font-mono text-[11px] uppercase tracking-widest font-bold border-b border-accent pb-1 text-foreground hover:text-accent transition-colors">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-24">
          {projects.slice(0, 4).map((p, i) => (
            ...
            >
              <div className="overflow-hidden bg-surf2 aspect-[4/3] relative border border-accent/10">
                <img
                  src={p.cover}
                  alt={p.name}
                  loading="lazy"
      ...
      <section className="bg-depth text-foreground relative overflow-hidden">
        ...
        <div className="container-x py-32 md:py-48 grid md:grid-cols-12 gap-16 relative z-10">
          ...
          <div className="md:col-span-6 md:col-start-7 flex flex-col justify-center">
             ...
             <div className="mt-12 text-sm font-ui text-foreground/50 leading-relaxed">
      ...
      <section className="container-x py-32 md:py-48">
        ...
        <h2 className="display text-5xl md:text-7xl leading-[1.05] text-foreground mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          {[
            ...
            { n: "04", t: "Entrega", d: "Testes, documentação e transferência formal sem surpresas." },
            ...
            <div key={s.t} className="flex flex-col items-center text-center group">
              <div className="w-16 h-16 rounded-full border-2 border-accent/30 flex items-center justify-center display text-xl text-foreground bg-depth group-hover:bg-accent group-hover:text-depth transition-all duration-500 mb-8 relative">
                {s.n}
                {i < 4 && (
                  <div className="hidden md:block absolute left-full top-1/2 w-8 h-px bg-accent/30 -translate-y-1/2" />
                )}
              </div>
              <h3 className="display text-lg text-foreground mb-4">{s.t}</h3>
      ...
      <section className="container-x py-40 md:py-60 text-center relative overflow-hidden">
        ...
        <h2 className="display text-6xl md:text-[100px] max-w-5xl mx-auto leading-[1.0] text-foreground">
