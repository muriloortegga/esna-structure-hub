        ...
        <div className="container-x grid md:grid-cols-12 gap-16 md:gap-24">
          <form onSubmit={onSubmit} className="md:col-span-7 flex flex-col gap-10">
            {[
              ...
              <div key={f.name} className="flex flex-col gap-4">
                ...
                <input
                  ...
                  type={f.type}
                  required
                  className="w-full bg-surface border border-border-sutil rounded-none px-6 py-4 text-h2 text-void focus:border-void outline-none transition-all"
                />
              </div>
            ))}
            <div className="flex flex-col gap-4">
              ...
              <textarea
                ...
                rows={5}
                required
                className="w-full bg-surface border border-border-sutil rounded-none px-6 py-4 text-h2 text-void focus:border-void outline-none transition-all resize-none"
              />
            </div>
            <button
              type="submit"
              disabled={loading}
              className="btn-esna-primary self-start px-12 py-4"
            >
          ...
          <aside className="md:col-span-5 flex flex-col gap-16">
            <div className="flex flex-col gap-8">
              <span className="text-nav text-void border-l-2 border-void pl-4 font-bold uppercase tracking-widest">Canais Diretos</span>
            ...
            <div className="card-surface p-10 bg-pale border-black/10">
