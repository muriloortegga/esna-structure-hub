        ...
        <div className="container-x grid md:grid-cols-2 gap-20 items-start">
          <div className="flex flex-col gap-6">
            <h2 className="text-display text-void leading-tight">
              <span className="font-light">Engenharia para</span> <br />
              <span className="font-bold">projetos integrados.</span>
            </h2>
          </div>
        ...
        <div className="container-x grid md:grid-cols-2 gap-20">
          <div className="flex flex-col gap-12">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-h2 text-gray-600 leading-relaxed font-light">
